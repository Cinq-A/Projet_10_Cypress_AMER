...
describe('Se connecter.', () => {
    ...
    it('ajouter le produit avec stock positif au panier ! Quantité = 1', () => {
            ...
            cy.get('[data-cy="cart-line-quantity"]').invoke('val').then(quantity => {
                ...
                if (quantity > '0') {
                    cy.log("Le produit en stock positif est ajouté au panier avec la quantité 1!");
                } else {
    ...
    it(`Afficher le stock du produit ID N° ${productId} après l'ajout de 1 dans le panier` , () => {
        ...
        cy.request({
          ...
          if (QTE_STOCK_actuelle === QTE_STOCK_initiale - 1 ) {
